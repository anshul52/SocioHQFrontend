...
//       >
//         <div
//           className="pointer-events-none absolute right-[6%] top-[8%] h-[170px] w-[170px] rounded-full blur-[100px]"
...
//           background-image:
//             radial-gradient(at 40% 36%, hsla(184, 99%, 68%, 1) 0px, transparent 50%),
//             radial-gradient(at 88% 98%, hsla(198, 92%, 63%, 1) 0px, transparent 50%),
//             radial-gradient(at 67% 72%, hsla(220, 89%, 71%, 1) 0px, transparent 50%),
//             radial-gradient(at 58% 96%, hsla(121, 79%, 70%, 1) 0px, transparent 50%),
//             radial-gradient(at 78% 69%, hsla(282, 84%, 77%, 1) 0px, transparent 50%),
//             radial-gradient(at 97% 95%, hsla(11, 84%, 70%, 1) 0px, transparent 50%),
//             radial-gradient(at 76% 97%, hsla(165, 94%, 77%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 13s ease infinite;
//         }

//         .socio-scroll-gradient-2 {
//           background-color: hsl(245, 62%, 96%);
//           background-image:
//             radial-gradient(at 58% 80%, hsla(240, 100%, 91%, 1) 0px, transparent 50%),
//             radial-gradient(at 91% 95%, hsla(240, 90%, 86%, 1) 0px, transparent 50%),
//             radial-gradient(at 81% 64%, hsla(243, 65%, 91%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 5s ease infinite;
//         }

//         .socio-scroll-gradient-3 {
//           background-color: hsl(24, 62%, 96%);
//           background-image:
//             radial-gradient(at 58% 80%, hsla(21, 69%, 89%, 1) 0px, transparent 50%),
//             radial-gradient(at 91% 95%, hsla(21, 76%, 86%, 1) 0px, transparent 50%),
//             radial-gradient(at 81% 64%, hsla(22, 62%, 81%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 13s ease infinite;
//         }

//         .socio-scroll-gradient-4 {
//           background-color: hsl(2, 86%, 94%);
//           background-image:
//             radial-gradient(at 58% 80%, hsla(2, 86%, 90%, 1) 0px, transparent 50%),
//             radial-gradient(at 91% 95%, hsla(2, 100%, 88%, 1) 0px, transparent 50%),
//             radial-gradient(at 81% 64%, hsla(1, 94%, 88%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 13s ease infinite;
//         }

//         .socio-scroll-gradient-5 {
//           background-color: hsl(150, 100%, 96%);
//           background-image:
//             radial-gradient(at 58% 80%, hsla(149, 75%, 92%, 1) 0px, transparent 50%),
//             radial-gradient(at 91% 95%, hsla(149, 93%, 90%, 1) 0px, transparent 50%),
//             radial-gradient(at 81% 64%, hsla(150, 100%, 93%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 13s ease infinite;
//         }
...
//           background-image:
//             radial-gradient(at 58% 80%, hsla(197, 90%, 87%, 1) 0px, transparent 50%),
//             radial-gradient(at 91% 95%, hsla(197, 91%, 92%, 1) 0px, transparent 50%),
//             radial-gradient(at 81% 64%, hsla(195, 79%, 88%, 1) 0px, transparent 50%);
//           background-size: 200% 200%;
//           animation: socioScrollGradient 13s ease infinite;
//         }
//       `}</style>
...
export default function ScrollStack() {
  return (
    <section className="relative w-full bg-white px-4 pb-20 pt-8 md:px-6 md:pb-28 md:pt-12 lg:px-8">
      ...
      <style jsx global>{`
        /* Optimized gradient animations using transform instead of background-position */
        @keyframes socioScrollGradientSubtle {
          0%,
          100% {
            opacity: 1;
          }
        ...
        /* Hardware-accelerated gradient backgrounds */
        .socio-scroll-gradient-1,
        .socio-scroll-gradient-2,
        .socio-scroll-gradient-3,
        .socio-scroll-gradient-4,
        ...
        /* Static gradients - much more performant */
        .socio-scroll-gradient-1 {
        ...
        /* Optional: Add subtle animation on hover only */
        .scroll-stack-home-card {
          transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        }

        .scroll-stack-home-card:hover {
